pageextension 60003 "PurchaseQuotesListExt" extends "Purchase Quotes"
{
    trigger OnOpenPage()
    var
        GenJourTemplateSubType: Enum "Gen. Jour. Template SubType";
    begin
        GenJnlManagement.TemplateSelectionForPurchase(49, GenJourTemplateSubType::Quote, Rec, JnlSelected, GenJnlTemplateCode);
