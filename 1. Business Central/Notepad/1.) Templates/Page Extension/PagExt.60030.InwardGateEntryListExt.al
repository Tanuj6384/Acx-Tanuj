pageextension 60030 InwardGateEntryListExt extends "Inward Gate Entry List"
{
    trigger OnOpenPage()
    var
        GenJourTemplateSubType: Enum "Gen. Jour. Template SubType";
    begin
        GenJnlManagement.TemplateSelectionForInwardGate(18605, GenJourTemplateSubType::GIR, Rec, JnlSelected, GenJnlTemplateCode);
