pageextension 60006 "PurchaseCreditMemosListExt" extends "Purchase Credit Memos"
{
    trigger OnOpenPage()
    var
        GenJourTemplateSubType: Enum "Gen. Jour. Template SubType";
    begin
        GenJnlManagement.TemplateSelectionForPurchase(52, GenJourTemplateSubType::"Credit Memo", Rec, JnlSelected, GenJnlTemplateCode);
