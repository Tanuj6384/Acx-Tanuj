pageextension 60004 "PurchOrderListExt" extends "Purchase Order List"
{
    layout
    {
    ...
    begin
        GenJnlManagement.TemplateSelectionForPurchase(50, GenJourTemplateSubType::Orders, Rec, JnlSelected, GenJnlTemplateCode);
