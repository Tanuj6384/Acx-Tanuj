pageextension 60016 SalesQuotationListExt extends "Sales Quotes"
{
    ...
    begin
        ...
        GenJnlManagement.TemplateSelectionForSales(41, GenJourTemplateSubType::Quote, Rec, JnlSelected, GenJnlTemplateCode);
