pageextension 60020 "SalesCreditMemosListExt" extends "Sales Credit Memos"
{
    trigger OnOpenPage()
    var
    ...
    begin
        ...
        GenJnlManagement.TemplateSelectionForSales(44, GenJourTemplateSubType::"Credit Memo", Rec, JnlSelected, GenJnlTemplateCode);
